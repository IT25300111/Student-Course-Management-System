...
import com.courseRegistration.studentRegistration.service.CourseService;
...
public class CourseController {
    ...
    @DeleteMapping("/{id}")
    public ApiMessage deleteCourse(@PathVariable Long id) {
        courseService.deleteCourse(id);
        return new ApiMessage("Course deleted successfully");
    }
}
